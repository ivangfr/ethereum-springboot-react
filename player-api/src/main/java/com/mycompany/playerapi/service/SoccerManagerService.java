...
public interface SoccerManagerService {
    ...
    Tuple5<String, BigInteger, String, Boolean, String> getPlayer(BigInteger playerId, String password, String file, BigInteger gasPrice, BigInteger gasLimit) throws Exception;
    ...
    List getAgentPlayers(String password, String file, BigInteger gasPrice, BigInteger gasLimit) throws Exception;
